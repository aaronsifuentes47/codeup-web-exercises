...
function calculateTip(percent, bill) {
    var toTip = bill * percent;
    return toTip.toFixed(2);
    }
// console.log(calculateTip(.20, 47.54));
    /**
     * TODO:
...
var billTip = Number(prompt("What percent would you like to tip?")/100);

alert(calculateTip(billTip, totalBill));
...
alert(applyDiscount(origPrice, discount));
})();